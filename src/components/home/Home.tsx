  ...
  return (
    ...
    >
      ...
      >
        {/* MAIN */}
        <div
          className={`wrapper md:px-20 md:pt-[120px] md:pb-6 flex pt-1 px-6 flex-col items-center md:flex-row`}
        >
          {/* LEFT SIDE */}
          <motion.div
            className="z-100 xs:w-5/ md:w-full text-center xs:m-auto xs:flex xs:flex-col xs:text-center xs:items-center md:items-center lg:items-start"
            initial={"hidden"}
            whileInView={"visible"}
          ...
          {/* RIGHT SIDE */}
          <div className="xs:flex xs:justify-center md:static basis-1/2 z-1">
            <img src={homeImg} alt="home-img" className="z-10" />
          </div>
        </div>
        {/* SPONSORS */}
